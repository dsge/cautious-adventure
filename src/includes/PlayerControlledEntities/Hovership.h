...
class Hovership : public godot::RigidBody3D, public PlayerControlledEntityInterface {
    GDCLASS(Hovership, godot::RigidBody3D);
...
public:
    ...
    HovershipControls* controls = nullptr;
